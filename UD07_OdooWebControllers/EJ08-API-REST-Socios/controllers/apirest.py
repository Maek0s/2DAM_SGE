...
class ApiRest(http.Controller):
    ...
    URL COMPLETA (Enviada con PUT/PATCH): http://localhost:8069/gestion/apirest/socio?data={"num_socio":"3", "nombre":"Sergi","apellidos":"Martínez"} 
    ...
    def apiPost(self, **args):
        ...
        print(f"Datos recibidos para {model}: {dicDatos}")  # Imprime los datos recibidos
